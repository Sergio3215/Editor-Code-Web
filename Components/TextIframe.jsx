    ...
    const handlerKeydown = (e)=>{
        if (e.key == 'Tab') {
          ...
          if (e.key == '>') {
            ...
            if(startIndex.includes(">") || (props.cssEdit || props.jsEdit)){
                autocomplet = ">"
            }
                ...
                (props.cssEdit) ?
                    (props.jsEdit) ?
                        <textarea onChange={(e) => props.handlerJS(e.target.value)}
                            value={props.js} style={{ width: 300, height: 300 }} 
                            onKeyDown={(e)=>handlerKeydown(e)} />
                        :
                        <textarea onChange={(e) => props.handlerCSS(e.target.value)}
                            value={props.css} style={{ width: 300, height: 300 }} 
                            onKeyDown={(e)=>handlerKeydown(e)} />
                    :
                    <textarea onChange={(e) => props.handlerHTML(e.target.value)}
                        value={props.html} style={{ width: 300, height: 300 }} 
                        onKeyDown={(e)=>handlerKeydown(e)}/>
            }
        </>
    )
